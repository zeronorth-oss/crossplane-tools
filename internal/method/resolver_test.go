...
func (mg *Model) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	mg.Spec.ForProvider.SecurityGroupID = reference.ToPtrValue[int32](rsp.ResolvedValue)
	mg.Spec.ForProvider.SecurityGroupIDRef = rsp.ResolvedReference

	rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
		CurrentValue: reference.FromValue(mg.Spec.ForProvider.SubnetIDs),
		Extract:      reference.ExternalName(),
		Reference:    mg.Spec.ForProvider.SubnetIDsRef,
	...
	mg.Spec.ForProvider.SubnetIDs = reference.ToValue[string](rsp.ResolvedValue)
	mg.Spec.ForProvider.SubnetIDsRef = rsp.ResolvedReference
	...
	mg.Spec.ForProvider.CustomConfiguration = reference.ToPtrValue[string](rsp.ResolvedValue)
	mg.Spec.ForProvider.CustomConfigurationRef = rsp.ResolvedReference
